...
void main() {
  ...
  group("测试url连通", () {
    ...
    test("测试url连通_可用-使用dio",() async {
      final sec = await checkUrl('http://39.134.115.163:8080/PLTV/88888910/224/3221225691/index.m3u8');
    ...
    test("测试url连通_不可用-使用dio", () async {
      ...
      final sec = await checkUrl(
          'https://bloomberg.com/media-manifest/streams/asia-event.m3u8',timeout: 10);
